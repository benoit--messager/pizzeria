...
privileged aspect Profile_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Profile.fieldNames4OrderClauseFilter = java.util.Arrays.asList("name");
    ...
    public static List<Profile> Profile.findAllProfiles(String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Profile o";
        ...
        return entityManager().createQuery(jpaQuery, Profile.class).getResultList();
    }
    ...
    public static List<Profile> Profile.findProfileEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Profile o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
        ...
        return entityManager().createQuery(jpaQuery, Profile.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
